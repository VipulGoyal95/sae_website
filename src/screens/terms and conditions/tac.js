  ...
  return (
    <>
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Terms and Conditions</h1>
        <p>
          Welcome to SAE NIT Kurukshetra! <br />
          <br />
          These terms and conditions outline the rules and regulations for the
          use of SAE NIT Kurukshetra's Website, located at
          https://saenitkurukshetra.in. <br />
          <br />
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use SAE NIT Kurukshetra if you do not
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Cookies</h1>
        <p>
          We employ the use of cookies. By accessing SAE NIT Kurukshetra, you
          agreed to use cookies in agreement with the SAE NIT Kurukshetra's
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>License</h1>
        <p>
          Unless otherwise stated, SAE NIT Kurukshetra and/or its licensors own
          the intellectual property rights for all material on SAE NIT
          Kurukshetra. All intellectual property rights are reserved. You may
          access this from SAE NIT Kurukshetra for your own personal use
          subjected to restrictions set in these terms and conditions.
          <br />
          <br /> You must not: Republish material from SAE NIT Kurukshetra
          <br />
          <br /> Sell, rent or sub-license material from SAE NIT Kurukshetra
          <br />
          <br />
          Reproduce, duplicate or copy material from SAE NIT Kurukshetra
          <br />
          <br />
          Redistribute content from SAE NIT Kurukshetra
          <br /> <br />
          ...
          exchange opinions and information in certain areas of the website. SAE
          NIT Kurukshetra does not filter, edit, publish or review Comments
          prior to their presence on the website. <br />
          <br />
          Comments do not reflect the views and opinions of SAE NIT
          Kurukshetra,its agents and/or affiliates. Comments reflect the views
          and opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, SAE NIT Kurukshetra shall not be
          ...
          <br />
          SAE NIT Kurukshetra reserves the right to monitor all Comments and to
          remove any Comments which can be considered inappropriate, offensive
          or causes breach of these Terms and Conditions.
          <br /> <br />
          You warrant and represent that:
          <br />
          <br /> You are entitled to post the Comments on our website and have
          ...
          <br />
          <br /> You hereby grant SAE NIT Kurukshetra a non-exclusive license to
      ...
      <div
        className="hyperlinkingtocontent"
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Hyperlinking to our Content</h1>
        <p>
          ...
          <br />
          <br /> associations or other groups representing charities; <br />
          <br />
          ...
          visibility of the hyperlink compensates the absence of SAE NIT
          Kurukshetra; and (d) the link is in the context of general resource
          information. <br />
          <br />
          ...
          sending an e-mail to SAE NIT Kurukshetra. Please include your name,
          ...
          locator being linked to; or <br />
          <br />
          By use of any other description of our Website being linked to that
          makes sense within the context and format of content on the linking
          party’s site.
          <br />
          <br /> No use of SAE NIT Kurukshetra's logo or other artwork will be
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>iFrames</h1>
        <p>
      ...
      <div
        className="content-liability"
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Content Liability</h1>
        <p>
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Your privacy</h1>
        <p>Please read Privacy Policy</p>
      </div>
      <div
        className="reservationofrights"
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Reservation of Rights</h1>
        <p>
      ...
      <div
        className="removaloflinks"
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Removal of links from our website</h1>
        <p>
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Disclaimer</h1>
        <p>
