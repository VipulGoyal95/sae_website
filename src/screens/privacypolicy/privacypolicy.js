    ...
    <>
      ...
      >
        <h1 style={{ fontSize: "24px" }}>
          Privacy Policy for SAE NIT Kurukshetra
        </h1>
        <p>
          At SAE NIT Kurukshetra, accessible from https://saenitkurukshetra.in,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by SAE NIT Kurukshetra and how we use it.
          <br />
          ...
          collect in SAE NIT Kurukshetra. This policy is not applicable to any
          ...
          shared and/or collect in SAE NIT Kurukshetra. This policy is not
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Consent</h1>
        <p>
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Information we collect</h1>
        <p>
          ...
          <br />
          <br />
          When you register for a Workshop, we may ask for your contact
          information, including items such as name, company name, college name,
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>How we use your information</h1>
        <p>
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Log Files</h1>
        <p>
          SAE NIT Kurukshetra follows a standard procedure of using log files.
          ...
          <br /> SAE NIT Kurukshetra does not log any files such as internet
      ...
      >
        ...
        <p>
          ...
          advertising partners of SAE NIT Kurukshetra. Third-party ad servers or
          ...
          on SAE NIT Kurukshetra, which are sent directly to users' browser.
          ...
          <br />
          <br /> Note that SAE NIT Kurukshetra has no access to or control over
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Third Party Privacy Policies</h1>
        <p>
          SAE NIT Kurukshetra's Privacy Policy does not apply to other
          ...
          <br />
          <br /> We do not use any coockies and we do not collaborate with any
          third party apps for sharing data and content.
        </p>
      </div>
      <div
      ...
      >
        ...
        <p>
          ...
          a business has collected about consumers. <br />
          <br />
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>GDPR Data Protection Rights</h1>
        <p>
      ...
      <div
        ...
        style={{ color: "white", width: "80%", margin: "0 auto 30px auto" }}
      >
        <h1 style={{ fontSize: "24px" }}>Children's Information</h1>
        <p>
          Another part of our priority is adding protection for children while
          using the internet. We encourage parents and guardians to observe,
          participate in, and/or monitor and guide their online activity.
          <br />
          <br /> SAE NIT Kurukshetra does not knowingly collect any Personal
